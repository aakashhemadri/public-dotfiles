...
set ve+=onemore " Allow cursor to move past end of line
" Set conceal level as 0
set conceallevel=0
let g:vim_markdown_conceal = 0

" Git/Linux dev config.
" Tab configurations
set tabstop=4 softtabstop=4 shiftwidth=4 noexpandtab cindent cc=80 | %retab " | autocmd BufWritePre * %s/\s\+$//e
set colorcolumn=81
